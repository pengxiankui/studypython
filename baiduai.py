...
foregroundimg = cv2.resize(foregroundimg,(2131,1438),interpolation=cv2.INTER_NEAREST)
...
labelmapimg = cv2.resize(labelmapimg,(2131, 1438),interpolation=cv2.INTER_NEAREST)
...
scoremapimg = cv2.resize(scoremapimg,(2131,1438),interpolation=cv2.INTER_NEAREST)
